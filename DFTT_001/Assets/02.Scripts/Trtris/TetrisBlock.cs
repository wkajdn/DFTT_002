...
public class TetrisBlock : MonoBehaviour
{
    ...
    private float comboResetTime = 3f; // 콤보 초기화 시간
    ...
    void Start()
    {
        spawner = FindObjectOfType<spawnertetris>();
    ...
    void Update()
    {
        ...
        {
            spawner.ResetCombo(); // spawner 객체의 ResetCombo() 함수 호출
    ...
    {
        spawner.IncreaseCombo();
        comboTimer = 0f; // 콤보 증가시 타이머 초기화
    }
    ...
    void DeleteLine(int i) //줄을 삭제한다.
    {
        ...
        FindObjectOfType<spawnertetris>().IncreaseCombo();
    }
